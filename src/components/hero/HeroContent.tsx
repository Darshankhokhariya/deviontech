...
const HeroContent = () => {
    return (
        <div className="text-center xl:text-start pt-5 md:pt-0 lg:pt-2 xl:pt-20">
            <span className="inline-flex items-center rounded-full bg-orange-100 px-5 py-2 text-xs font-medium text-primary">Making the world a better place!</span>
            <p
                ...
                Delivering <span className='px-2 text-primary'>innovative</span> and adaptable IT solutions to drive your digital success.
            </p>

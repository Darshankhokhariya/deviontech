                    ...
                    <div className="container mx-auto px-4">
                        <div className="my-40 md:mb-24 text-center max-w-4xl mx-auto">
                            <h1 className="mb-16 text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight lg:leading-[50px] xl:leading-[70px] text-heading text-center">
                                <span>Driving Positive Change Through <span className='bg-orange-100 px-2'>Technology</span> – Empowering Progress, One Solution at a Time.</span>
                            </h1>
                            ...
                            <a href="#contact">
                                <Button className='bg-primary cursor-pointer text-sm tracking-normal px-10 py-3 mt-8 rounded font-bold text-white hover:bg-primary/80 transition-all duration-300' text='Get a Quote' />
                            </a>
                        </div>
                    </div>
                </section>
            ...
            {/* <section className="my-10 md:my-24 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight text-heading text-center mb-12">
                        Meet Our <span className="bg-orange-100 px-2">Leadership</span>
                    </div>
                    <div className="flex flex-col md:flex-row justify-center items-center gap-10">
                        {team.map((member) => (
                            <div key={member.name} className="bg-white/80 rounded-xl p-8 shadow-xl border border-orange-100 backdrop-blur-md flex flex-col items-center w-72">
                                ...
                                <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">LinkedIn</a>
                            </div>
                        ))}
                    </div>
                </div>
